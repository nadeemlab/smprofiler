...
from smprofiler.db.representative_subsample import Subsampler
from smprofiler.db.representative_subsample import DEFAULT_MAX
...
def parse_args():
    parser = argparse.ArgumentParser(
        prog='smprofiler db cache-subsample',
